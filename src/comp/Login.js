    ...
    <div className='form'>
      <div className='form-con'>
        <div className='form-lft'>
          <h1>Welcome<br></br>to<br></br>The NewsFlash</h1>
        ...
        <div className='form-rgt'>
          ...
          <button className='btn' onClick={login}>Login as a User</button>
          <button className='btn' onClick={login}>Login as a Admin</button>
