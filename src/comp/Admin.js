...
const Admin = () => {
  ...
  return (
    <div className="newscon">
      ...
      <div className="news-grid" style={{marginLeft:"390px",marginRight:"290px"}}>
        {posts.map((objs) => {
          return (
            <>
              {objs.status == "pending" && (
                <div className="newscard" key={obj.id}>
                  ...
                  <input type="text" onChange={fun} style={{height:"40px",width:"100px"}}/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <button onClick={() => upd("review", objs._id)} style={{marginbuttom:"50px"}}>
                    Send for revision
                  </button>
                  <div className="foot">
